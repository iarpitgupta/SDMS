...
public class QueryControllerModel {
    ...
    public int getTrainitrainingPartnerNamengPartnerId() {
        return trainingPartnerId;
    }

    public void setTrainitrainingPartnerNamengPartnerId(int trainitrainingPartnerNamengPartnerId) {
